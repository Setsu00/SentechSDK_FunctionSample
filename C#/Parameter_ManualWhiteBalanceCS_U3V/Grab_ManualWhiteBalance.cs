...
namespace Parameter_ManualWhiteBalance_U3V
{
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                using (CStDataStream dataStream = device.CreateStDataStream())
                {
                    ...
                    enumBalanceWhiteAuto.FromString("Off");

                    // 赤の比率値にアクセスするためBalanceRatioSelectorをRedに切替
                    // Switch balance ratio selector to Red for access Red ratio value
